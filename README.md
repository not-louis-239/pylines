...
* Dynamic sky, terrain and building lighting, sun, moon, stars and clouds.
...
**Map/Tool Controls** 
* M - show/hide map
* O - toggle controls quick reference
* While map is open:
  * W/S - zoom in/out
  * Arrows - pan map
  * Space - re-centre
...
* Changes will be recorded via semantic versioning.
* New features will be included in future updates, see "Planned Features".
...
* Combat gameplay with enemy planes
* Unit switching
